...
- themes, icons & vectors: [tumblr themes](https://www.tumblr.com/themes) - [noun project](https://thenounproject.com) - [vectors](https://www.humaaans.com) - [svg shapes](https://tool.graphics/shapes) - [streamlinehq](https://www.streamlinehq.com/icons)
...
- python: [weekly](https://www.pythonweekly.com/archive) - [automate boring stuff with python](https://automatetheboringstuff.com)- [practical](https://practicalpython.yasoob.me/toc.html) - [tutorial](https://docs.python.org/3/tutorial/appetite.html) - [resources](https://learnbyexample.github.io/py_resources/intermediate.html) 
...
- databases: [dbeaver](https://dbeaver.io) - sql client [one](https://franchise.cloud), [two](https://sqlnotebook.com) & [three](https://rosefinchapp.com) - [evidence](https://www.evidence.dev)
